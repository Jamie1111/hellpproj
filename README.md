...
build-css && node-sass-chokidar src/ -o src/ --watch --recursive",
...
You don’t necessarily need a static server in order to run a Create React App project in production. It works just as fine int
